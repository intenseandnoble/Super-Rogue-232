...
//		this.setLocation(dim.width/2-this.getSize().width/2, dim.height/2-this.getSize().height/2);
		...
		// Le premier chiffre du textArea d�fini la hauteur et peut �tre
		// augment� au besoin.
		...
		// Lorsque ASWD sera impl�ment�, on pourra utiliser le SOUTH pour
		// d�crire les �v�nements (ex. le contenu d'un coffre ouvert)

...
public class TestGame extends TestCase {
	...
	public void testMove() {
		...
		myGame.move(myGame.getHero(), new Coord(0, 1));
		myGame.move(myGame.getHero(), new Coord(0, 1));
		assertTrue(myGame.getHero().getPosition().equals(new Coord(2, 3)));
	}

	public void testOpen() {
		Game myGame = new Game("maps/smallWorld.txt");
		myGame.open(myGame.getHero(), new Coord(1, 0));
		assertTrue((myGame.getWorld().getChar(new Coord(3, 2))) == '/');
	}

	public void testHp() {
		Game myGame = new Game("maps/smallWorld.txt");
		myGame.getHero().getHit(5);
		assertTrue(myGame.getHero().getHp() == 0);
	}
